...
{
    [DbContext(typeof(OnlineCardShopDbContext))]
    [Migration("20220927155324_FixingImagesAndCardsRelationship")]
    partial class FixingImagesAndCardsRelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineCardShop.Data.Models.Card", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineCardShop.Data.Models.Card", b =>
                {
                    b.HasOne("OnlineCardShop.Data.Models.Category", "Category")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("OnlineCardShop.Data.Models.Image", b =>
                {
                    b.HasOne("OnlineCardShop.Data.Models.Card", "Card")
                        .WithOne("Image")
                        .HasForeignKey("OnlineCardShop.Data.Models.Image", "CardId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
